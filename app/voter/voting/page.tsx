...
export default function VotingPage() {
  ...
  const handleVoteClick = (candidate: any) => {
    if (user.votedCategories.includes(candidate.category) || user.tokensRemaining <= 0 || !isConnected) {
      return
    }
  ...
  const confirmVote = async () => {
    if (!selectedCandidate || !isConnected) return
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <Card className="max-w-md">
          <CardHeader className="text-center">
            ...
            <CardDescription>Necesitas conectar tu wallet para poder votar</CardDescription>
          </CardHeader>
          <CardContent className="text-center">
            <p className="mb-4">Por favor, conecta tu wallet desde el botón en la barra de navegación.</p>
                      ...
                      >
                        <CardContent className="p-6 text-center">
                          ...
                          <Button
                            ...
                            disabled={categoryHasVoted || user.tokensRemaining <= 0 || !isConnected}
                            className={`w-full ${
                              categoryHasVoted
                                ? "bg-gray-400"
                                : !isConnected
